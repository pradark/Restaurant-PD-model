...
def bayes_parameter_opt_lgb(X, y, categorical_feats, init_round=15, opt_round=25, n_folds=3, random_seed=137, n_estimators=1000, output_process=False):
    import warnings
    ...
    def lgb_eval(num_leaves, min_data_in_leaf, learning_rate, min_sum_hessian_in_leaf, feature_fraction, bagging_fraction, max_depth, lambda_l1, lambda_l2, min_split_gain, min_child_weight):
        ...
        'boost_from_average': False, 'is_unbalance': True, 'early_stopping_round':100, 'verbose':-1, 'metric':'auc'}
    ...
    lgbBO = BayesianOptimization(lgb_eval, bounds_LGB, random_state=137)
    # optimize
