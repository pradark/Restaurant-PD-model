...
FIXED VERSION: Delays SHAP import to avoid protobuf conflicts
"""
...
# NOTE: SHAP import is delayed until it's actually needed
...
# Figure 3: SHAP Bar Chart (WITH DELAYED IMPORT)
print("  [Loading SHAP for figure generation...]")
try:
    import shap
    ...
    print(f"  ⚠ SHAP import/execution failed: {e}")
    print(f"    Skipping SHAP figures (fig_shap_bar.png, fig_shap_summary.png)")
